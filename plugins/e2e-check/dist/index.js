...
const definition = {
  manifest,
  activate: async (ctx) => {
    ctx.logger.info("e2e-check activated");
  },
  deactivate: async (ctx) => {
    ctx?.logger.info("e2e-check deactivated");
  },
};
